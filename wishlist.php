...
<head>
    ...
    <title>Mystic coffee-wishlist</title>
</head>
<body>
...
<section class="products">
    <div class="title">products added to wishlist</div>
        ...
        if ($select_wishlist->rowCount() > 0) {
            ...
            <form action="" method="post" class="box">
                ...
                <button type="submit" name="add_to_cart"><i class="bx bx-cart"></i></button>
                        <a href="view_page.php?pid=<?php echo $fetch_products[
                            "id"
                        ]; ?>" class="bx bxs-show"></a>
                        <button type="submit" name="delete_item" onclick="return confirm('delete this item');"><i class="bx bx-x"></i></button>
                </div>
                <h3 class="name"><?= $fetch_products["name"] ?></h3>
                <input type="hidden" name="product_id" value="<?= $fetch_products[
                    "id"
                ] ?>">
                <div class="flex">
                    <p class="price">price  $<?= $fetch_products["price"] ?></p>
                </div>
                <a href="checkout.php?get_id=<?= $fetch_products[
                    "id"
                ] ?>" class="btn">buy now</a>
            </form>
